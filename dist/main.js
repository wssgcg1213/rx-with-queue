...
/******/ 	var hotCurrentHash = "449d307544a067ba4e1f"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	$input.value = random();
	function createAction(type, value = null, item = null) {
	    return {
	        type,
	        value,
	        item
	...
	const btn$ = rxjs_1.Observable.fromEvent($btnGroup, 'click')
	    .map((evt) => createAction((evt.target['className'].match(/button-(\S+)/) || [, null])[1], $input.value))
	...
	const app$ = btn$.merge(item$)
	    ...
	    .subscribe((action) => console.log(action), (err) => console.error(err));
	//# sourceMappingURL=data:application/json;base64,
